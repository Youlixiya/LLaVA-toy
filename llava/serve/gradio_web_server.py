...
with gr.Blocks(title='SAM-LLaVA🚀', theme=gr.themes.Default(), css=block_css) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=7):
            chatbot = gr.Chatbot(label="SAM-LLaVA", bubble_full_width=True).style(height=750)
            with gr.Row():
