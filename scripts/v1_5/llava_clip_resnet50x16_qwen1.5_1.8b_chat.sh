deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-clip-resnet20x16-qwen-v1.5-1.8b-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --image_folder data \
    --vision_tower clip_resnet50x16 \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-clip-resnet20x16-qwen-v1.5-1.8b-pretrain/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-clip-resnet20x16-qwen-v1.5-1.8b \
    --num_train_epochs 1 \
...
# deepspeed llava/train/train_mem.py \
#     --deepspeed ./scripts/zero2.json \
#     --model_name_or_path ./checkpoints/llava-tinyclip-tinyllama-v1.0-1.1b-3t \
