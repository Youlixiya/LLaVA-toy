deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-clip-resnet50x16-phi-2.7b-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --image_folder data \
    --vision_tower clip_resnet50x16 \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-clip-resnet50x16-phi-2.7b-pretrain/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
