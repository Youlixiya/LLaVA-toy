deepspeed llava/train/train_mem.py \
    ...
    --vision_tower ./ckpts/siglip-so400m-patch14-384 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-siglip-tinyllama-v1.0-1.1b-3t-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --image_folder data \
    --vision_tower ./ckpts/siglip-so400m-patch14-384 \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-siglip-tinyllama-v1.0-1.1b-3t-pretrain/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-siglip-tinyllama-v1.0-1.1b-3t \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path ./checkpoints/llava-siglip-tinyllama-v1.0-1.1b-3t \
    --version llava_tinyllama \
    ...
    --group_by_modality_length True \
    --bf16 True \
    --output_dir ./checkpoints/llava-siglip-tinyllama-v1.0-1.1b-3t-rec \
    --num_train_epochs 1 \
