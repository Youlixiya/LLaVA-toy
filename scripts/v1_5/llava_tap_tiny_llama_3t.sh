deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-tap-tinyllama-v1.0-1.1b-3t-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --image_folder data \
    --vision_tower tap \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-tap-tinyllama-v1.0-1.1b-3t-pretrain/mm_projector.bin \
    --mm_projector_type tap \
    --mm_vision_select_layer -1 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-tap-tinyllama-v1.0-1.1b-3t \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --group_by_modality_length True \
    --bf16 True \
    --output_dir ./checkpoints/llava-tap-tinyllama-v1.0-1.1b-3t-rec \
    --num_train_epochs 1 \
    --per_device_train_batch_size 8 \
    --per_device_eval_batch_size 4 \
    --gradient_accumulation_steps 2 \
