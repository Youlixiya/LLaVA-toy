deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-tinyllama-v1.0-1.1b-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --vision_tower ./ckpts/clip-vit-large-patch14 \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-tinyllama-v1.0-1.1b-pretrain/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-tinyllama-v1.0-1.1b-lora \
    --num_train_epochs 1 \
