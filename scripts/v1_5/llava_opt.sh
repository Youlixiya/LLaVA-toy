deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llavaopt-125m-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --vision_tower ./ckpts/clip-vit-large-patch14 \
    --pretrain_mm_mlp_adapter ./checkpoints/llavaopt-125m-pretrain/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llavaopt-125m \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path ./checkpoints/llavaopt-125m \
    --version opt \
    ...
    --group_by_modality_length True \
    --bf16 True \
    --output_dir  ./checkpoints/llavaopt-125m-rec \
    --num_train_epochs 1 \
    --per_device_train_batch_size 4 \
    --per_device_eval_batch_size 1 \
    --gradient_accumulation_steps 4 \
